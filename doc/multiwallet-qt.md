...
In order to support loading of multiple wallets in blockdomain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is blockdomain.cpp.
...
Changes to blockdomain.cpp
----------------------
blockdomain.cpp is the entry point into blockdomain-qt, and as such, will require some minor modifications to provide hooks for
