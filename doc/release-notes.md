BlockDomain Core version 2.2.1 is now available from:

  <https://github.com/blockdomain-project/blockdomain/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/blockdomain-project/blockdomain/issues>

Compatibility
==============

BlockDomain Core is extensively tested on multiple operating systems using
...
BlockDomain Core should also work on most other Unix-like systems but is not
...
of Bitcoin that BlockDomain was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/blockdomain-project-translations/).
