Contributing to BlockDomain Core
============================

The BlockDomain Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BlockDomain Core project, and is not to be
confused with overall BlockDomain Network Protocol consensus changes.

Whether a pull request is merged into BlockDomain Core rests with the project merge
...
Patches that change BlockDomain consensus rules are considerably more involved than
...
Where a patch set proposes to change the BlockDomain consensus, it must have been
...
The project leader is the release manager for each BlockDomain Core release.
