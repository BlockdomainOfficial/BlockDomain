...
This means one can have an always-on blockdomaind instance running, and another local blockdomaind/blockdomain-qt instance which connects to this node and receives blocks from it.
