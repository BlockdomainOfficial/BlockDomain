...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/blockdomain-config.h \
           src/crypto/common.h \
		   src/crypto/scrypt.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/blockdomain-cli.cpp \
           src/blockdomain-tx.cpp \
           src/blockdomain.cpp \
           src/db.cpp \
           ...
           src/qt/blockdomain.cpp \
           src/qt/blockdomainstrings.cpp \
...
RESOURCES += src/qt/blockdomain.qrc src/qt/blockdomain_locale.qrc

TRANSLATIONS += src/qt/locale/blockdomain_bg.ts \
                src/qt/locale/blockdomain_de.ts \
                src/qt/locale/blockdomain_en.ts \
                src/qt/locale/blockdomain_es.ts \
                src/qt/locale/blockdomain_fi.ts \
                src/qt/locale/blockdomain_fr.ts \
                src/qt/locale/blockdomain_it.ts \
                src/qt/locale/blockdomain_ja.ts \
                src/qt/locale/blockdomain_pl.ts \
                src/qt/locale/blockdomain_pt.ts \
                src/qt/locale/blockdomain_ru.ts \
                src/qt/locale/blockdomain_sk.ts \
                src/qt/locale/blockdomain_sv.ts \
                src/qt/locale/blockdomain_vi.ts \
                src/qt/locale/blockdomain_zh_CN.ts \
                src/qt/locale/blockdomain_zh_TW.ts
