...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BlockDomain Core"),
     ...
     * override -datadir in the blockdomain.conf file in the default data directory
     * (to be consistent with blockdomaind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
