                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BlockDomain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BlockDomain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and blockdomain: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BlockDomain Core"), this);
    aboutAction->setStatusTip(tr("Show information about BlockDomain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BlockDomain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BlockDomain addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BlockDomain addresses"));
    ...
    openAction->setStatusTip(tr("Open a BlockDomain: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BlockDomain Core help message to get a list with possible BlockDomain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BlockDomain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BlockDomain network", "", count));
}
...
{
    QString strTitle = tr("BlockDomain Core"); // default title
