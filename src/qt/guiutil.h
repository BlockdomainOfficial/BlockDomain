...
/** Utility functions used by the BlockDomain Qt UI.
 */
namespace GUIUtil
{
...
// Render BlockDomain addresses in monospace font
...
// Parse "blockdomain:" URI into recipient object, return true on successful parsing
