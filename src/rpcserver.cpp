...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BlockDomain server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "BlockDomain server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BlockDomain features */
        {"blockdomain", "masternode", &masternode, true, true, false},
        {"blockdomain", "masternodelist", &masternodelist, true, true, false},
        {"blockdomain", "mnbudget", &mnbudget, true, true, false},
        {"blockdomain", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"blockdomain", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"blockdomain", "mnsync", &mnsync, true, true, false},
        {"blockdomain", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"blockdomain", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use blockdomaind, or the -server option to blockdomain-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> blockdomain-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41236/\n";
}
