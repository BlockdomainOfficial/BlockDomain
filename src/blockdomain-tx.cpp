...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BlockDomain Core blockdomain-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  blockdomain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded blockdomain transaction") + "\n" +
                               "  blockdomain-tx [options] -create [commands]   " + _("Create hex-encoded blockdomain transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded blockdomain transaction
