...
#if defined(NDEBUG)
#error "BlockDomain cannot be compiled without assertions."
#endif
...
unsigned int nStakeMinAge = 60 * 60 * 3; // 3 Hours
...
int64_t GetBlockValue(int nHeight)
{
	...
	if(IsTreasuryBlock(nHeight)) {
		...
		nSubsidy = 1 * COIN;	
		} else if (nHeight <= 4000 && nHeight > 3000) {
		nSubsidy = 25 * COIN;
		} else if (nHeight <= 5000 && nHeight > 4500) {
		nSubsidy = 100 * COIN;	
		} else if (nHeight <= 4500 && nHeight > 5000) {
		nSubsidy = 250 * COIN;
		} else if (nHeight <= 6000 && nHeight > 5000) {
		nSubsidy = 175 * COIN;	
		} else if (nHeight <= 10000 && nHeight > 7000) {
		nSubsidy = 100 * COIN;	
		} else if (nHeight <= 100000 && nHeight > 10000) {
		nSubsidy = 75 * COIN;	
    ...
    if (nMoneySupply + nSubsidy >= 85000000 * COIN)
        nSubsidy = 85000000 - nMoneySupply;

    if (nMoneySupply >= 85000000 * COIN)
	nSubsidy = 0;
...
int nStartTreasuryBlock = 2186;
int nTreasuryBlockStep = 186;
	...
	if(IsTreasuryBlock(nHeight)) {
		if(nHeight == nStartTreasuryBlock) {
			...
			if (nHeight <= 3000 && nHeight > 0) {
				nSubsidy = (92.5 + 1) * COIN;	
			} else if (nHeight <= 4000 && nHeight > 3000) {
				nSubsidy = (235.2 + 25) * COIN;
			} else if (nHeight <= 4500 && nHeight > 4000) {
				nSubsidy = (930 + 100) * COIN;	
			} else if (nHeight <= 5000 && nHeight > 4500) {
				nSubsidy = (2325 + 250) * COIN;
			} else if (nHeight <= 7000 && nHeight > 5000) {
				nSubsidy = (1627.5 + 175) * COIN;	
			} else if (nHeight <= 10000 && nHeight > 7000) {
				nSubsidy = (930 + 100) * COIN;	
			} else if (nHeight <= 100000 && nHeight > 10000) {
				nSubsidy = (697.5 + 75) * COIN;	
			} else if (nHeight > 100000) {
				nSubsidy = (465 + 50) * COIN;
			}
			return nSubsidy;
...
{
    RenameThread("blockdomain-scriptch");
